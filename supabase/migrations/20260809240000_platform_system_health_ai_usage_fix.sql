-- Flowtix Platform System Health — AI Usage Relation Fix
--
-- Forward-only corrective migration for Platform System Health.
-- Flowtix's durable AI usage ledger is public.ai_usage_reservations.
-- No AI usage rows, provider behavior, entitlements, or customer data are changed.
