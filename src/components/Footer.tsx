  ...
  return (
    <footer className="border-t border-white/10 bg-[#07111F] px-6 py-14 text-slate-400">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_2fr]">
        <div><div className="text-xl font-semibold text-white">Flowtix</div><p className="mt-4 max-w-sm text-sm leading-7">A multi-tenant cloud dialer and CRM workspace for teams managing customer conversations.</p></div>
      ...
      <div className="mx-auto mt-12 max-w-7xl border-t border-white/10 pt-6 text-sm">© {new Date().getFullYear()} Flowtix. All rights reserved.</div>
    </footer>
  )
}
