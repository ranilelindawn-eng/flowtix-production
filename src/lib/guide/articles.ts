...
export const guideArticles: GuideArticle[] = [
  ...
  {
    slug: 'live-calls', title: 'Live Calls', category: 'Calling & Telephony', summary: 'Monitor active calls across Twilio, Telnyx, SignalWire, and Plivo in one provider-neutral view.', moduleHref: '/dashboard/live-calls', moduleLabel: 'Open Live Calls', pathnamePrefixes: ['/dashboard/live-calls'],
    steps: [
