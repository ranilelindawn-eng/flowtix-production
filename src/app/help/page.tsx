...
export const metadata: Metadata = { title: 'CallFlow Help Center', description: 'Find setup guidance, account help, and answers about the current CallFlow application.' }
const items = [
...
export default function Page() { return <MarketingShell><MarketingHero eyebrow='Support' title='CallFlow Help Center' description='Find setup guidance, account help, and answers about the current CallFlow application.' /><ContentSection title="Explore CallFlow"><CardGrid items={items} /></ContentSection></MarketingShell> }
