...
export const metadata: Metadata = { title: 'Connect CallFlow to your operating stack', description: 'The integration architecture is designed for secure, organization-scoped connections. Individual providers must be configured before their features become active.' }
const items = [
  ...
  { title: 'CRM imports', description: 'Bring contact data into CallFlow using controlled import workflows as they are enabled.' },
...
export default function Page() { return <MarketingShell><MarketingHero eyebrow='Integrations' title='Connect CallFlow to your operating stack' description='The integration architecture is designed for secure, organization-scoped connections. Individual providers must be configured before their features become active.' /><ContentSection title="Explore CallFlow"><CardGrid items={items} /></ContentSection></MarketingShell> }
