...
export const metadata: Metadata = { title: 'AI-ready conversation intelligence', description: 'CallFlow includes structured areas for transcripts, summaries, and insights. Automated AI processing requires a separately configured provider and is never represented as active until connected.' }
const items = [
...
export default function Page() { return <MarketingShell><MarketingHero eyebrow='AI features' title='AI-ready conversation intelligence' description='CallFlow includes structured areas for transcripts, summaries, and insights. Automated AI processing requires a separately configured provider and is never represented as active until connected.' /><ContentSection title="Explore CallFlow"><CardGrid items={items} /></ContentSection></MarketingShell> }
