...
export const metadata = createMarketingMetadata({
  ...
  description:
    'Read the Flowtix Acceptable Use Policy for lawful communications, consent, anti-spam requirements, prohibited activity, platform security, and enforcement.',
  path: '/acceptable-use',
})

export default function Page() { return <PolicyPage eyebrow="Legal" title="Acceptable Use Policy" description="Flowtix may only be used for lawful, authorized, and responsible communications.">
...
<section><h2>Enforcement</h2><p>Flowtix may investigate suspected abuse and restrict or suspend access where reasonably necessary to protect users, providers, the public, or the platform. Serious violations may be reported to relevant providers or authorities.</p></section>
</PolicyPage> }
