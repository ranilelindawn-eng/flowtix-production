...
export default function Page() { return <MarketingShell><MarketingHero eyebrow="Trust center" title="Security is part of the architecture" description="Flowtix uses server-side authorization and organization-scoped database policies. External carrier, AI, and storage providers must be reviewed and configured separately before production use." /><ContentSection title="Security controls"><CardGrid items={items} /></ContentSection></MarketingShell> }
