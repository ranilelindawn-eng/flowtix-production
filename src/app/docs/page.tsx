...
export const metadata: Metadata = { title: 'CallFlow product documentation', description: 'Reference guidance for workspace setup, security, data organization, and application workflows.' }
const items = [
...
export default function Page() { return <MarketingShell><MarketingHero eyebrow='Documentation' title='CallFlow product documentation' description='Reference guidance for workspace setup, security, data organization, and application workflows.' /><ContentSection title="Explore CallFlow"><CardGrid items={items} /></ContentSection></MarketingShell> }
