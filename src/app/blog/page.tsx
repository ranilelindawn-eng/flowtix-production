...
export const metadata: Metadata = { title: 'CallFlow Blog', description: 'Product notes and practical guidance for building better customer-conversation workflows.' }
const items = [
...
export default function Page() { return <MarketingShell><MarketingHero eyebrow='Resources' title='CallFlow Blog' description='Product notes and practical guidance for building better customer-conversation workflows.' /><ContentSection title="Explore CallFlow"><CardGrid items={items} /></ContentSection></MarketingShell> }
