  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-5"><Building2 className="h-5 w-5 text-cyan-400" /><p className="mt-4 text-sm text-slate-400">Organization</p><p className="mt-1 text-xl font-bold text-white">{settings?.name ?? 'Flowtix Workspace'}</p></div>
