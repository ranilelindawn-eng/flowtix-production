...
export default async function RolesPage() {
  ...
  return (
    <div className="space-y-6">
      <div><p className="text-sm font-medium text-cyan-400">Access control</p><h1 className="mt-1 text-3xl font-bold text-white">Roles & Permissions</h1><p className="mt-2 text-slate-400">Review the permission matrix applied throughout CallFlow.</p></div>
