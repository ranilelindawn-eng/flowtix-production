...
export default async function AgentAnalyticsPage({ searchParams }: Props) {
  ...
  return <div className="space-y-8">
    ...
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      <MetricCard label="Active agents" value={snapshot.totalAgents.toLocaleString()} helper={`${snapshot.availableAgents} available · ${snapshot.busyAgents} busy`} icon={<Users className="h-5 w-5" />} />
